...
namespace Calcasa.Api.Model
{
    ...
    /// WaarderingObject
    /// </summary>
    [DataContract(Name = "Waardering_object")]
    public partial class WaarderingObject : IEquatable<WaarderingObject>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WaarderingObject" /> class.
        /// </summary>
        ...
        public WaarderingObject(WoningType? woningType = default(WoningType?), int bouwjaar = default(int), int oppervlak = default(int), int perceeloppervlak = default(int), int inhoud = default(int), Energielabel? energielabel = default(Energielabel?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WaarderingObject {\n");
        ...
        {
            return this.Equals(input as WaarderingObject);
        }

        /// <summary>
        /// Returns true if WaarderingObject instances are equal
        /// </summary>
        /// <param name="input">Instance of WaarderingObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WaarderingObject input)
        {
            if (input == null)
            {
                return false;
