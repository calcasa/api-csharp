...
namespace Calcasa.Api.Model
{
    ...
    public partial class VorigeVerkoop
    {
        ...
        [JsonConstructor]
        public VorigeVerkoop(Option<int?> verkoopprijs = default, Option<int?> geindexeerdeVerkoopprijs = default, Option<int?> vierkantemeterprijs = default, Option<int?> geindexeerdeVierkantemeterprijs = default, Option<DateOnly?> verkoopdatum = default, Option<int?> perceeloppervlak = default, Option<List<VerkoopBijzonderheden>?> bijzonderheden = default)
        {
        ...
        public int? Perceeloppervlak { get { return this.PerceeloppervlakOption.Value; } set { this.PerceeloppervlakOption = new(value); } }
