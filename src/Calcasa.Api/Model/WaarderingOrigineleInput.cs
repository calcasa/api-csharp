...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Waardering_origineleInput")]
    public partial class WaarderingOrigineleInput : IEquatable<WaarderingOrigineleInput>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WaarderingOrigineleInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WaarderingOrigineleInput()
        {
        ...
        public WaarderingOrigineleInput(string geldverstrekker = default(string), ProductType productType = default(ProductType), int hypotheekwaarde = default(int), Aanvraagdoel? aanvraagdoel = default(Aanvraagdoel?), int klantwaarde = default(int), KlantwaardeType? klantwaardeType = default(KlantwaardeType?), bool isBestaandeWoning = default(bool), long bagNummeraanduidingId = default(long), bool isNhg = default(bool), bool isBestaandeNhgHypotheek = default(bool), int benodigdeOverbrugging = default(int), DateTime? peildatum = default(DateTime?), bool? isErfpacht = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WaarderingOrigineleInput {\n");
        ...
        {
            return this.Equals(input as WaarderingOrigineleInput);
        }

        /// <summary>
        /// Returns true if WaarderingOrigineleInput instances are equal
        /// </summary>
        /// <param name="input">Instance of WaarderingOrigineleInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WaarderingOrigineleInput input)
        {
            if (input == null)
            {
                return false;
