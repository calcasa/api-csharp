...
namespace Calcasa.Api.Model
{
    ...
    public partial class Taxatiedata : IEquatable<Taxatiedata>
    {
        ...
        public Taxatiedata(string taxatieorganisatie = default(string), string taxateurnaam = default(string), Taxatiestatus? status = default(Taxatiestatus?), DateTime taxatiedatum = default(DateTime))
        {
