...
namespace Calcasa.Api.Model
{
    ...
    public partial class Taxatiedata
    {
        ...
        [JsonConstructor]
        public Taxatiedata(Option<string?> taxatieorganisatie = default, Option<string?> taxateurnaam = default, Option<Taxatiestatus?> status = default, Option<DateTime?> taxatiedatum = default)
        {
    ...
    public class TaxatiedataJsonConverter : JsonConverter<Taxatiedata>
    {
        ...
        public override Taxatiedata Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Taxatiedata(taxatieorganisatie, taxateurnaam, status, taxatiedatum);
        }
