...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Referentieobject_object")]
    public partial class ReferentieobjectObject : IEquatable<ReferentieobjectObject>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferentieobjectObject" /> class.
        /// </summary>
        ...
        public ReferentieobjectObject(WoningType? woningType = default(WoningType?), int bouwjaar = default(int), int oppervlak = default(int), int perceeloppervlak = default(int), int inhoud = default(int), Energielabel? energielabel = default(Energielabel?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReferentieobjectObject {\n");
        ...
        {
            return this.Equals(input as ReferentieobjectObject);
        }

        /// <summary>
        /// Returns true if ReferentieobjectObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ReferentieobjectObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReferentieobjectObject input)
        {
            if (input == null)
            {
                return false;
