...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Omgevingsdata_provincie")]
    public partial class OmgevingsdataProvincie : IEquatable<OmgevingsdataProvincie>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OmgevingsdataProvincie" /> class.
        /// </summary>
        ...
        public OmgevingsdataProvincie(string naam = default(string), int? gemiddeldePrijsEengezinswoningen = default(int?), int? gemiddeldePrijsMeergezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsEengezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsMeergezinswoningen = default(int?), int? prijsveranderingAfgelopenJaar = default(int?), int? prijsveranderingAfgelopen3Jaar = default(int?), int? prijsveranderingAfgelopen5Jaar = default(int?), int? prijsveranderingAfgelopen10Jaar = default(int?))
        {
            this.Naam = naam;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OmgevingsdataProvincie {\n");
        ...
        {
            return this.Equals(input as OmgevingsdataProvincie);
        }

        /// <summary>
        /// Returns true if OmgevingsdataProvincie instances are equal
        /// </summary>
        /// <param name="input">Instance of OmgevingsdataProvincie to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OmgevingsdataProvincie input)
        {
            if (input == null)
            {
                return false;
