...
namespace Calcasa.Api.Model
{
    ...
    public partial class Waardering : IEquatable<Waardering>
    {
        ...
        /// </summary>
        /// <value>De huidige status van de waardering. | Waarde | Omschrijving | | - -- | - -- | | &#x60;onbekend&#x60; | Status onbekend. | | &#x60;initialiseren&#x60; | Deze waardering is geinitialiseerd maar moet nog bevestigd worden. | | &#x60;open&#x60; | Deze waardering is bevestigd maar moet nog uitgevoerd worden. | | &#x60;voltooid&#x60; | Deze waardering is voltooid. | | &#x60;opgewaardeerd&#x60; | Deze waardering is geupgrade naar een ander waardering type. | | &#x60;ongeldig&#x60; | Deze waardering is niet geldig, bijvoorbeeld omdat hij niet door de business rules is gekomen. | | &#x60;verlopen&#x60; | Deze waardering is verlopen omdat hij niet op tijd bevestigd is. | | &#x60;error&#x60; | Er is iets mis gegaan voor deze waardering. | | &#x60;inBehandeling&#x60; | Deze waardering is in behandeling door het systeem. |   </value>
        ...
        /// <param name="status">De huidige status van de waardering. | Waarde | Omschrijving | | - -- | - -- | | &#x60;onbekend&#x60; | Status onbekend. | | &#x60;initialiseren&#x60; | Deze waardering is geinitialiseerd maar moet nog bevestigd worden. | | &#x60;open&#x60; | Deze waardering is bevestigd maar moet nog uitgevoerd worden. | | &#x60;voltooid&#x60; | Deze waardering is voltooid. | | &#x60;opgewaardeerd&#x60; | Deze waardering is geupgrade naar een ander waardering type. | | &#x60;ongeldig&#x60; | Deze waardering is niet geldig, bijvoorbeeld omdat hij niet door de business rules is gekomen. | | &#x60;verlopen&#x60; | Deze waardering is verlopen omdat hij niet op tijd bevestigd is. | | &#x60;error&#x60; | Er is iets mis gegaan voor deze waardering. | | &#x60;inBehandeling&#x60; | Deze waardering is in behandeling door het systeem. |   .</param>
        ...
        public Waardering(Guid id = default(Guid), DateTime aangemaakt = default(DateTime), WaarderingStatus? status = default(WaarderingStatus?), WaarderingOrigineleInput origineleInput = default(WaarderingOrigineleInput), ReferentieobjectAdres adres = default(ReferentieobjectAdres), WaarderingModel model = default(WaarderingModel), WaarderingTaxatie taxatie = default(WaarderingTaxatie), WaarderingObject _object = default(WaarderingObject), WaarderingCbsIndeling cbsIndeling = default(WaarderingCbsIndeling), Collection<Foto> fotos = default(Collection<Foto>), Collection<Referentieobject> referenties = default(Collection<Referentieobject>), Collection<VorigeVerkoop> vorigeVerkopen = default(Collection<VorigeVerkoop>), WaarderingRapport rapport = default(WaarderingRapport), WaarderingFactuur factuur = default(WaarderingFactuur))
        {
            this.Id = id;
        ...
        public WaarderingOrigineleInput OrigineleInput { get; set; }
        ...
        public WaarderingModel Model { get; set; }

        /// <summary>
        /// Gets or Sets Taxatie
        /// </summary>
        [DataMember(Name = "taxatie", EmitDefaultValue = true)]
        public WaarderingTaxatie Taxatie { get; set; }

        /// <summary>
        /// Gets or Sets Object
        /// </summary>
        [DataMember(Name = "object", EmitDefaultValue = true)]
        public WaarderingObject Object { get; set; }

        /// <summary>
        /// Gets or Sets CbsIndeling
        /// </summary>
        [DataMember(Name = "cbsIndeling", EmitDefaultValue = true)]
        public WaarderingCbsIndeling CbsIndeling { get; set; }
        ...
        public WaarderingRapport Rapport { get; set; }

        /// <summary>
        /// Gets or Sets Factuur
        /// </summary>
        [DataMember(Name = "factuur", EmitDefaultValue = true)]
        public WaarderingFactuur Factuur { get; set; }
