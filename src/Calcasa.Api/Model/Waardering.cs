...
namespace Calcasa.Api.Model
{
    ...
    public partial class Waardering
    {
        ...
        [JsonConstructor]
        public Waardering(Guid id, DateTime aangemaakt, WaarderingStatus status, WaarderingInputParameters origineleInput, Adres adres, Option<Modeldata?> model = default, Option<Taxatiedata?> taxatie = default, Option<Objectdata?> @object = default, Option<Opnamedata?> opname = default, Option<CbsIndeling?> cbsIndeling = default, Option<List<Foto>?> fotos = default, Option<List<Referentieobject>?> referenties = default, Option<List<VorigeVerkoop>?> vorigeVerkopen = default, Option<Rapport?> rapport = default, Option<Factuur?> factuur = default, Option<Funderingdata?> fundering = default)
        {
            Id = id;
        ...
        public Modeldata? Model { get { return this.ModelOption.Value; } set { this.ModelOption = new(value); } }
        ...
        public Taxatiedata? Taxatie { get { return this.TaxatieOption.Value; } set { this.TaxatieOption = new(value); } }
        ...
        public Opnamedata? Opname { get { return this.OpnameOption.Value; } set { this.OpnameOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<Referentieobject>?> ReferentiesOption { get; private set; }

        /// <summary>
        /// Gets or Sets Referenties
        /// </summary>
        [JsonPropertyName("referenties")]
        public List<Referentieobject>? Referenties { get { return this.ReferentiesOption.Value; } set { this.ReferentiesOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<VorigeVerkoop>?> VorigeVerkopenOption { get; private set; }

        /// <summary>
        /// Gets or Sets VorigeVerkopen
        /// </summary>
        [JsonPropertyName("vorigeVerkopen")]
        public List<VorigeVerkoop>? VorigeVerkopen { get { return this.VorigeVerkopenOption.Value; } set { this.VorigeVerkopenOption = new(value); } }
        ...
        public Rapport? Rapport { get { return this.RapportOption.Value; } set { this.RapportOption = new(value); } }
        ...
        public Factuur? Factuur { get { return this.FactuurOption.Value; } set { this.FactuurOption = new(value); } }
        ...
        public Funderingdata? Fundering { get { return this.FunderingOption.Value; } set { this.FunderingOption = new(value); } }
    ...
    public class WaarderingJsonConverter : JsonConverter<Waardering>
    {
        ...
        public override Waardering Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Referentieobject>?> referenties = default;
            Option<List<VorigeVerkoop>?> vorigeVerkopen = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "fotos":
                            ...
                            break;
                        case "referenties":
                            referenties = new Option<List<Referentieobject>?>(JsonSerializer.Deserialize<List<Referentieobject>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "vorigeVerkopen":
                            vorigeVerkopen = new Option<List<VorigeVerkoop>?>(JsonSerializer.Deserialize<List<VorigeVerkoop>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "rapport":
