...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Referentieobject_adres")]
    public partial class ReferentieobjectAdres : IEquatable<ReferentieobjectAdres>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferentieobjectAdres" /> class.
        /// </summary>
        ...
        public ReferentieobjectAdres(string straat = default(string), int huisnummer = default(int), string huisnummertoevoeging = default(string), string postcode = default(string), string woonplaats = default(string))
        {
            this.Straat = straat;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReferentieobjectAdres {\n");
        ...
        {
            return this.Equals(input as ReferentieobjectAdres);
        }

        /// <summary>
        /// Returns true if ReferentieobjectAdres instances are equal
        /// </summary>
        /// <param name="input">Instance of ReferentieobjectAdres to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReferentieobjectAdres input)
        {
            if (input == null)
            {
                return false;
