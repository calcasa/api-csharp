...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Funderingdata_optrekkendVochtRisico")]
    public partial class FunderingdataOptrekkendVochtRisico : IEquatable<FunderingdataOptrekkendVochtRisico>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FunderingdataOptrekkendVochtRisico" /> class.
        /// </summary>
        ...
        public FunderingdataOptrekkendVochtRisico(FunderingRisicoLabel? label = default(FunderingRisicoLabel?), FunderingSoortBron? bron = default(FunderingSoortBron?), string omschrijving = default(string))
        {
            this.Label = label;
            this.Bron = bron;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FunderingdataOptrekkendVochtRisico {\n");
        ...
        {
            return this.Equals(input as FunderingdataOptrekkendVochtRisico);
        }

        /// <summary>
        /// Returns true if FunderingdataOptrekkendVochtRisico instances are equal
        /// </summary>
        /// <param name="input">Instance of FunderingdataOptrekkendVochtRisico to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunderingdataOptrekkendVochtRisico input)
        {
            if (input == null)
            {
                return false;
