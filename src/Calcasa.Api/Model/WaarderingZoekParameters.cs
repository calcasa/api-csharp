...
namespace Calcasa.Api.Model
{
    ...
    public partial class WaarderingZoekParameters
    {
        ...
        public WaarderingStatus? WaarderingStatus { get { return this.WaarderingStatusOption.Value; } set { this.WaarderingStatusOption = new(value); } }
        ...
        public DateTime? Aangemaakt { get { return this.AangemaaktOption.Value; } set { this.AangemaaktOption = new(value); } }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "aanvraagdoel":
                            ...
                            aanvraagdoel = new Option<Aanvraagdoel?>(aanvraagdoelRawValue == null ? null : AanvraagdoelValueConverter.FromStringOrDefault(aanvraagdoelRawValue));
                            break;
                        case "waarderingStatus":
                            string? waarderingStatusRawValue = utf8JsonReader.GetString();
                            waarderingStatus = new Option<WaarderingStatus?>(waarderingStatusRawValue == null ? null : WaarderingStatusValueConverter.FromStringOrDefault(waarderingStatusRawValue));
                            break;
                        default:
                            break;
                    }
