...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdresInfo_notities")]
    public partial class AdresInfoNotities : IEquatable<AdresInfoNotities>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdresInfoNotities" /> class.
        /// </summary>
        ...
        public AdresInfoNotities(Notitie? straat = default(Notitie?), Notitie? huisnummer = default(Notitie?), Notitie? huisnummertoevoeging = default(Notitie?), Notitie? postcode = default(Notitie?), Notitie? woonplaats = default(Notitie?))
        {
            this.Straat = straat;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdresInfoNotities {\n");
        ...
        {
            return this.Equals(input as AdresInfoNotities);
        }

        /// <summary>
        /// Returns true if AdresInfoNotities instances are equal
        /// </summary>
        /// <param name="input">Instance of AdresInfoNotities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdresInfoNotities input)
        {
            if (input == null)
            {
                return false;
