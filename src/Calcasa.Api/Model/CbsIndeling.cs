...
namespace Calcasa.Api.Model
{
    ...
    public partial class CbsIndeling : IEquatable<CbsIndeling>
    {
        ...
        public CbsIndeling(int buurtId = default(int), string buurtCode = default(string), string buurtnaam = default(string), string wijknaam = default(string), string gemeentenaam = default(string))
        {
        ...
        /// </summary>
        /// <value>De buurt code zoals bekend bij het CBS (Centraal Bureau voor de Statistiek).</value>
        [DataMember(Name = "buurtCode", EmitDefaultValue = false)]
        ...
        public bool Equals(CbsIndeling input)
        {
            ...
            return 
                ...
                (
                    this.BuurtCode == input.BuurtCode ||
                    (this.BuurtCode != null &&
                    this.BuurtCode.Equals(input.BuurtCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BuurtCode != null)
                {
                    hashCode = (hashCode * 59) + this.BuurtCode.GetHashCode();
                }
