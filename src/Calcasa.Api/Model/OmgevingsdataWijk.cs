...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Omgevingsdata_wijk")]
    public partial class OmgevingsdataWijk : IEquatable<OmgevingsdataWijk>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OmgevingsdataWijk" /> class.
        /// </summary>
        ...
        public OmgevingsdataWijk(string naam = default(string), int? gemiddeldePrijsEengezinswoningen = default(int?), int? gemiddeldePrijsMeergezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsEengezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsMeergezinswoningen = default(int?), int? prijsveranderingAfgelopenJaar = default(int?), int? prijsveranderingAfgelopen3Jaar = default(int?), int? prijsveranderingAfgelopen5Jaar = default(int?), int? prijsveranderingAfgelopen10Jaar = default(int?))
        {
            this.Naam = naam;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OmgevingsdataWijk {\n");
        ...
        {
            return this.Equals(input as OmgevingsdataWijk);
        }

        /// <summary>
        /// Returns true if OmgevingsdataWijk instances are equal
        /// </summary>
        /// <param name="input">Instance of OmgevingsdataWijk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OmgevingsdataWijk input)
        {
            if (input == null)
            {
                return false;
