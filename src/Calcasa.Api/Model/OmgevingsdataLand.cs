...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Omgevingsdata_land")]
    public partial class OmgevingsdataLand : IEquatable<OmgevingsdataLand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OmgevingsdataLand" /> class.
        /// </summary>
        ...
        public OmgevingsdataLand(string naam = default(string), int? gemiddeldePrijsEengezinswoningen = default(int?), int? gemiddeldePrijsMeergezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsEengezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsMeergezinswoningen = default(int?), int? prijsveranderingAfgelopenJaar = default(int?), int? prijsveranderingAfgelopen3Jaar = default(int?), int? prijsveranderingAfgelopen5Jaar = default(int?), int? prijsveranderingAfgelopen10Jaar = default(int?))
        {
            this.Naam = naam;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OmgevingsdataLand {\n");
        ...
        {
            return this.Equals(input as OmgevingsdataLand);
        }

        /// <summary>
        /// Returns true if OmgevingsdataLand instances are equal
        /// </summary>
        /// <param name="input">Instance of OmgevingsdataLand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OmgevingsdataLand input)
        {
            if (input == null)
            {
                return false;
