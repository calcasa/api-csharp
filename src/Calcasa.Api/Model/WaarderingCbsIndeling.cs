...
{
    /// <summary>
    /// WaarderingCbsIndeling
    /// </summary>
    [DataContract(Name = "Waardering_cbsIndeling")]
    public partial class WaarderingCbsIndeling : IEquatable<WaarderingCbsIndeling>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WaarderingCbsIndeling" /> class.
        /// </summary>
        ...
        public WaarderingCbsIndeling(int buurtId = default(int), string buurtnaam = default(string), string wijknaam = default(string), string gemeentenaam = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WaarderingCbsIndeling {\n");
        ...
        {
            return this.Equals(input as WaarderingCbsIndeling);
        }

        /// <summary>
        /// Returns true if WaarderingCbsIndeling instances are equal
        /// </summary>
        /// <param name="input">Instance of WaarderingCbsIndeling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WaarderingCbsIndeling input)
        {
            if (input == null)
            {
                return false;
