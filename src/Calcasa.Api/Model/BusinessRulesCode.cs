...
namespace Calcasa.Api.Model
{
    ...
    public enum BusinessRulesCode
    {
        ...
        /// <summary>
        /// Enum GeenEigenBewoning for value: geenEigenBewoning
        /// </summary>
        GeenEigenBewoning,

        /// <summary>
        /// Enum IncorrecteErfpacht for value: incorrecteErfpacht
        /// </summary>
        IncorrecteErfpacht
    }
    ...
    public static class BusinessRulesCodeValueConverter
    {
        ...
        public static BusinessRulesCode FromString(string value)
        {
            ...
            if (value.Equals("geenEigenBewoning"))
                return BusinessRulesCode.GeenEigenBewoning;

            if (value.Equals("incorrecteErfpacht"))
                return BusinessRulesCode.IncorrecteErfpacht;
        ...
        public static string ToJsonValue(BusinessRulesCode value)
        {
            ...
            if (value == BusinessRulesCode.GeenEigenBewoning)
                return "geenEigenBewoning";

            if (value == BusinessRulesCode.IncorrecteErfpacht)
                return "incorrecteErfpacht";
    ...
    public class BusinessRulesCodeJsonConverter : JsonConverter<BusinessRulesCode>
    {
        ...
        {
            writer.WriteStringValue(BusinessRulesCodeValueConverter.ToJsonValue(businessRulesCode).ToString());
        }
    }
    ...
    public class BusinessRulesCodeNullableJsonConverter : JsonConverter<BusinessRulesCode?>
    {
        ...
        public override void Write(Utf8JsonWriter writer, BusinessRulesCode? businessRulesCode, JsonSerializerOptions options)
        {
            writer.WriteStringValue(businessRulesCode.HasValue ? BusinessRulesCodeValueConverter.ToJsonValue(businessRulesCode.Value).ToString() : "null");
        }
    }
