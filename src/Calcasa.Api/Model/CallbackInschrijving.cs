...
namespace Calcasa.Api.Model
{
    ...
    public partial class CallbackInschrijving : IEquatable<CallbackInschrijving>
    {
        ...
        public CallbackInschrijving(long bagNummeraanduidingId = default(long), DateTime geldigTot = default(DateTime), string externeReferentie = default(string), string geldverstrekker = default(string))
        {
