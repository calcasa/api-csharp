...
namespace Calcasa.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Omgevingsdata_buurt")]
    public partial class OmgevingsdataBuurt : IEquatable<OmgevingsdataBuurt>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OmgevingsdataBuurt" /> class.
        /// </summary>
        ...
        public OmgevingsdataBuurt(string naam = default(string), int? gemiddeldePrijsEengezinswoningen = default(int?), int? gemiddeldePrijsMeergezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsEengezinswoningen = default(int?), int? gemiddeldeVierkantemeterPrijsMeergezinswoningen = default(int?), int? prijsveranderingAfgelopenJaar = default(int?), int? prijsveranderingAfgelopen3Jaar = default(int?), int? prijsveranderingAfgelopen5Jaar = default(int?), int? prijsveranderingAfgelopen10Jaar = default(int?))
        {
            this.Naam = naam;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OmgevingsdataBuurt {\n");
        ...
        {
            return this.Equals(input as OmgevingsdataBuurt);
        }

        /// <summary>
        /// Returns true if OmgevingsdataBuurt instances are equal
        /// </summary>
        /// <param name="input">Instance of OmgevingsdataBuurt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OmgevingsdataBuurt input)
        {
            if (input == null)
            {
                return false;
