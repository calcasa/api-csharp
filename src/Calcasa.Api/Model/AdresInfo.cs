...
namespace Calcasa.Api.Model
{
    ...
    public partial class AdresInfo : IEquatable<AdresInfo>
    {
        ...
        public AdresInfo(long bagNummeraanduidingId = default(long), AdresInfoAdres adres = default(AdresInfoAdres), AdresInfoNotities notities = default(AdresInfoNotities), bool? adresGevonden = default(bool?))
        {
        ...
        public AdresInfoAdres Adres { get; set; }

        /// <summary>
        /// Gets or Sets Notities
        /// </summary>
        [DataMember(Name = "notities", EmitDefaultValue = true)]
        public AdresInfoNotities Notities { get; set; }
