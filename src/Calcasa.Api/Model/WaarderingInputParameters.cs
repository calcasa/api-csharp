...
namespace Calcasa.Api.Model
{
    ...
    public partial class WaarderingInputParameters
    {
        ...
        public Aanvraagdoel? Aanvraagdoel { get { return this.AanvraagdoelOption.Value; } set { this.AanvraagdoelOption = new(value); } }
        ...
        public KlantwaardeType? KlantwaardeType { get { return this.KlantwaardeTypeOption.Value; } set { this.KlantwaardeTypeOption = new(value); } }
        ...
        /// <summary>
        /// Ongebruikt voor de meeste client typen op dit moment. Deze informatie komt uit de credentials. Als dit veld wel verplicht is dan is dit gecommuniceerd.
        /// </summary>
        /// <value>Ongebruikt voor de meeste client typen op dit moment. Deze informatie komt uit de credentials. Als dit veld wel verplicht is dan is dit gecommuniceerd.</value>
        [JsonPropertyName("geldverstrekker")]
        public string? Geldverstrekker { get { return this.GeldverstrekkerOption.Value; } set { this.GeldverstrekkerOption = new(value); } }
        ...
        public int? Hypotheekwaarde { get { return this.HypotheekwaardeOption.Value; } set { this.HypotheekwaardeOption = new(value); } }
        ...
        public int? Klantwaarde { get { return this.KlantwaardeOption.Value; } set { this.KlantwaardeOption = new(value); } }
        ...
        public bool? IsBestaandeWoning { get { return this.IsBestaandeWoningOption.Value; } set { this.IsBestaandeWoningOption = new(value); } }
        ...
        public bool? IsNhg { get { return this.IsNhgOption.Value; } set { this.IsNhgOption = new(value); } }
        ...
        public bool? IsBestaandeNhgHypotheek { get { return this.IsBestaandeNhgHypotheekOption.Value; } set { this.IsBestaandeNhgHypotheekOption = new(value); } }
        ...
        /// <summary>
        /// Verplicht voor de combinatie van de producttypen &#x60;modelwaardeDesktopTaxatie&#x60;, &#x60;desktopTaxatie&#x60; en &#x60;desktopTaxatiePlus&#x60; en het aanvraagdoel &#x60;overbruggingsfinanciering&#x60;. In hele euros.
        /// </summary>
        /// <value>Verplicht voor de combinatie van de producttypen &#x60;modelwaardeDesktopTaxatie&#x60;, &#x60;desktopTaxatie&#x60; en &#x60;desktopTaxatiePlus&#x60; en het aanvraagdoel &#x60;overbruggingsfinanciering&#x60;. In hele euros.</value>
        [JsonPropertyName("benodigdeOverbrugging")]
        public int? BenodigdeOverbrugging { get { return this.BenodigdeOverbruggingOption.Value; } set { this.BenodigdeOverbruggingOption = new(value); } }
        ...
        public DateOnly? Peildatum { get { return this.PeildatumOption.Value; } set { this.PeildatumOption = new(value); } }
        ...
        public bool? IsErfpacht { get { return this.IsErfpachtOption.Value; } set { this.IsErfpachtOption = new(value); } }
        ...
        public string? Klantkenmerk { get { return this.KlantkenmerkOption.Value; } set { this.KlantkenmerkOption = new(value); } }
        ...
        public bool? HeeftAflossingsvrijDeel { get { return this.HeeftAflossingsvrijDeelOption.Value; } set { this.HeeftAflossingsvrijDeelOption = new(value); } }
        ...
        public int? AflossingsvrijDeel { get { return this.AflossingsvrijDeelOption.Value; } set { this.AflossingsvrijDeelOption = new(value); } }
        ...
        public int? Verdieping { get { return this.VerdiepingOption.Value; } set { this.VerdiepingOption = new(value); } }
        ...
        public bool? WoonadresInBuitenland { get { return this.WoonadresInBuitenlandOption.Value; } set { this.WoonadresInBuitenlandOption = new(value); } }
        ...
        public long? WoonadresBagNummeraanduidingId { get { return this.WoonadresBagNummeraanduidingIdOption.Value; } set { this.WoonadresBagNummeraanduidingIdOption = new(value); } }
        ...
        public string? Opdrachtgever { get { return this.OpdrachtgeverOption.Value; } set { this.OpdrachtgeverOption = new(value); } }
    ...
    public class WaarderingInputParametersJsonConverter : JsonConverter<WaarderingInputParameters>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, WaarderingInputParameters waarderingInputParameters, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (waarderingInputParameters.VerdiepingOption.IsSet)
                if (waarderingInputParameters.VerdiepingOption.Value != null)
                    writer.WriteNumber("verdieping", waarderingInputParameters.VerdiepingOption.Value!.Value);
                else
                    writer.WriteNull("verdieping");

            if (waarderingInputParameters.WoonadresInBuitenlandOption.IsSet)
                if (waarderingInputParameters.WoonadresInBuitenlandOption.Value != null)
                    writer.WriteBoolean("woonadresInBuitenland", waarderingInputParameters.WoonadresInBuitenlandOption.Value!.Value);
                else
                    writer.WriteNull("woonadresInBuitenland");

            if (waarderingInputParameters.WoonadresBagNummeraanduidingIdOption.IsSet)
                if (waarderingInputParameters.WoonadresBagNummeraanduidingIdOption.Value != null)
                    writer.WriteNumber("woonadresBagNummeraanduidingId", waarderingInputParameters.WoonadresBagNummeraanduidingIdOption.Value!.Value);
                else
                    writer.WriteNull("woonadresBagNummeraanduidingId");

            if (waarderingInputParameters.OpdrachtgeverOption.IsSet)
                if (waarderingInputParameters.OpdrachtgeverOption.Value != null)
                    writer.WriteString("opdrachtgever", waarderingInputParameters.Opdrachtgever);
                else
