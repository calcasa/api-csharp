...
namespace Calcasa.Api.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface ILengthRequired<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is LengthRequired
        /// </summary>
        /// <returns></returns>
        TType LengthRequired();

        /// <summary>
        /// Returns true if the response is LengthRequired and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryLengthRequired([NotNullWhen(true)] out TType? result);
    }
