...
namespace Calcasa.Api.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _services.AddTransient<IAdressenApi, AdressenApi>();
            _services.AddSingleton<BestemmingsplannenApiEvents>();
            _services.AddTransient<IBestemmingsplannenApi, BestemmingsplannenApi>();
            _services.AddSingleton<BodemApiEvents>();
            _services.AddTransient<IBodemApi, BodemApi>();
            _services.AddSingleton<BuurtApiEvents>();
            _services.AddTransient<IBuurtApi, BuurtApi>();
            _services.AddSingleton<CallbacksApiEvents>();
            _services.AddTransient<ICallbacksApi, CallbacksApi>();
            _services.AddSingleton<ConfiguratieApiEvents>();
            _services.AddTransient<IConfiguratieApi, ConfiguratieApi>();
            _services.AddSingleton<FacturenApiEvents>();
            _services.AddTransient<IFacturenApi, FacturenApi>();
            _services.AddSingleton<FotosApiEvents>();
            _services.AddTransient<IFotosApi, FotosApi>();
            _services.AddSingleton<FunderingenApiEvents>();
            _services.AddTransient<IFunderingenApi, FunderingenApi>();
            _services.AddSingleton<GeldverstrekkersApiEvents>();
            _services.AddTransient<IGeldverstrekkersApi, GeldverstrekkersApi>();
            _services.AddSingleton<RapportenApiEvents>();
            _services.AddTransient<IRapportenApi, RapportenApi>();
            _services.AddSingleton<WaarderingenApiEvents>();
            _services.AddTransient<IWaarderingenApi, WaarderingenApi>();
        }
