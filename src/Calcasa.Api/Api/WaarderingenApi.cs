...
namespace Calcasa.Api.Api
{
    ...
    /// </summary>
    public interface ISearchWaarderingenApiResponse : Calcasa.Api.Client.IApiResponse, IOk<List<Waardering>?>, IBadRequest<Calcasa.Api.Model.InvalidArgumentProblemDetails?>, IUnauthorized<Calcasa.Api.Model.UnauthorizedProblemDetails?>, IForbidden<Calcasa.Api.Model.PermissionsDeniedProblemDetails?>, IUnprocessableContent<Microsoft.AspNetCore.Mvc.ValidationProblemDetails?>, IDefault<Microsoft.AspNetCore.Mvc.ProblemDetails?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class WaarderingenApi : IWaarderingenApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/waarderingen/check"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/waarderingen/check");

                    httpRequestMessageLocalVar.Content = (productCheckParameters as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
        ...
        public async Task<ICreateWaarderingApiResponse> CreateWaarderingAsync(WaarderingInputParameters waarderingInputParameters, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/waarderingen"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/waarderingen");

                    httpRequestMessageLocalVar.Content = (waarderingInputParameters as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
                        ? httpRequestMessageLocalVar.Content = new StreamContent(fileParameterLocalVar.Content)
        ...
        /// <summary>
        /// Waardering op basis van Id. Het waarderingsobject zal gefilterd terugkomen, afhankelijk van het client_id dat gebruikt is voor de authenticatie.
        /// </summary>
        /// <param name="id">De waardering Id in de vorm van een UUID.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetWaarderingApiResponse"/>&gt;</returns>
        ...
        public async Task<IGetWaarderingApiResponse> GetWaarderingAsync(Guid id, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/waarderingen/{id}"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/waarderingen/{id}");
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/waarderingen/by-hash/{hash}");
        ...
        /// <summary>
        /// Waardering ontwikkeling op basis van waardering Id. Het waarderingsobject zal gefilterd terugkomen, afhankelijk van het client_id dat gebruikt is voor de authenticatie.
        /// </summary>
        /// <param name="id">De waardering Id in de vorm van een UUID.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetWaarderingOntwikkelingApiResponse"/>&gt;</returns>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/waarderingen/{id}/ontwikkeling");
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7Bid%7D", Uri.EscapeDataString(id.ToString()));
        ...
        public async Task<IPatchWaarderingenApiResponse> PatchWaarderingenAsync(Guid id, List<Microsoft.AspNetCore.JsonPatch.Operations.Operation> listMicrosoftAspNetCoreJsonPatchOperationsOperation, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    httpRequestMessageLocalVar.Content = (listMicrosoftAspNetCoreJsonPatchOperationsOperation as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
                        ? httpRequestMessageLocalVar.Content = new StreamContent(fileParameterLocalVar.Content)
        ...
        /// <summary>
        /// Zoek waardering op basis van input parameters. Het waarderingsobject zal gefilterd terugkomen, afhankelijk van het client_id dat gebruikt is voor de authenticatie. Alle items kunnen gebruikt worden voor het zoeken, ProductType en BagNummeraanduidingId zijn verplicht.  
        /// </summary>
        /// <param name="waarderingZoekParameters"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ISearchWaarderingenApiResponse"/>&gt;</returns>
        ...
        public async Task<ISearchWaarderingenApiResponse> SearchWaarderingenAsync(WaarderingZoekParameters waarderingZoekParameters, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/waarderingen/zoeken"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/waarderingen/zoeken");

                    httpRequestMessageLocalVar.Content = (waarderingZoekParameters as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
                        ? httpRequestMessageLocalVar.Content = new StreamContent(fileParameterLocalVar.Content)
        ...
        public partial class SearchWaarderingenApiResponse : Calcasa.Api.Client.ApiResponse, ISearchWaarderingenApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public List<Waardering>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<Waardering>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)] out List<Waardering>? result)
            {
                result = null;
