...
namespace Calcasa.Api.Api
{
    ...
    public interface IGeldverstrekkersApiSync : IApiAccessor
    {
        ...
        /// <returns>Collection&lt;Geldverstrekker&gt;</returns>
        Collection<Geldverstrekker> GetGeldverstrekkers(ProductType productType);
        ...
        /// <exception cref="Calcasa.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="productType">Een parameter om de lijst te filteren op gesupporte producttypen.</param>
        /// <returns>ApiResponse of Collection&lt;Geldverstrekker&gt;</returns>
        ApiResponse<Collection<Geldverstrekker>> GetGeldverstrekkersWithHttpInfo(ProductType productType);
    ...
    public interface IGeldverstrekkersApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of Collection&lt;Geldverstrekker&gt;</returns>
        System.Threading.Tasks.Task<Collection<Geldverstrekker>> GetGeldverstrekkersAsync(ProductType productType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="productType">Een parameter om de lijst te filteren op gesupporte producttypen.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Collection&lt;Geldverstrekker&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<Collection<Geldverstrekker>>> GetGeldverstrekkersWithHttpInfoAsync(ProductType productType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GeldverstrekkersApi : IDisposable, IGeldverstrekkersApi
    {
        ...
        /// <param name="productType">Een parameter om de lijst te filteren op gesupporte producttypen.</param>
        /// <returns>Collection&lt;Geldverstrekker&gt;</returns>
        public Collection<Geldverstrekker> GetGeldverstrekkers(ProductType productType)
        {
            Calcasa.Api.Client.ApiResponse<Collection<Geldverstrekker>> localVarResponse = GetGeldverstrekkersWithHttpInfo(productType);
        ...
        /// <param name="productType">Een parameter om de lijst te filteren op gesupporte producttypen.</param>
        /// <returns>ApiResponse of Collection&lt;Geldverstrekker&gt;</returns>
        public Calcasa.Api.Client.ApiResponse<Collection<Geldverstrekker>> GetGeldverstrekkersWithHttpInfo(ProductType productType)
        {
            ...
            var localVarResponse = this.Client.Get<Collection<Geldverstrekker>>("/api/v1/geldverstrekkers/{productType}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Collection&lt;Geldverstrekker&gt;</returns>
        public async System.Threading.Tasks.Task<Collection<Geldverstrekker>> GetGeldverstrekkersAsync(ProductType productType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Calcasa.Api.Client.ApiResponse<Collection<Geldverstrekker>> localVarResponse = await GetGeldverstrekkersWithHttpInfoAsync(productType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Collection&lt;Geldverstrekker&gt;)</returns>
        public async System.Threading.Tasks.Task<Calcasa.Api.Client.ApiResponse<Collection<Geldverstrekker>>> GetGeldverstrekkersWithHttpInfoAsync(ProductType productType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Collection<Geldverstrekker>>("/api/v1/geldverstrekkers/{productType}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
