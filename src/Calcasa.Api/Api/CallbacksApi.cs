...
namespace Calcasa.Api.Api
{
    ...
    /// </summary>
    public interface IGetNotificationSubscriptionsApiResponse : Calcasa.Api.Client.IApiResponse, IOk<List<CallbackInschrijving>?>, IUnauthorized<Calcasa.Api.Model.UnauthorizedProblemDetails?>, IForbidden<Calcasa.Api.Model.PermissionsDeniedProblemDetails?>, IDefault<Microsoft.AspNetCore.Mvc.ProblemDetails?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class CallbacksApi : ICallbacksApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/callbacks/inschrijvingen");

                    httpRequestMessageLocalVar.Content = (callbackInschrijving as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/callbacks/inschrijvingen/{bagNummeraanduidingId}");
        ...
        public partial class GetNotificationSubscriptionsApiResponse : Calcasa.Api.Client.ApiResponse, IGetNotificationSubscriptionsApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public List<CallbackInschrijving>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<CallbackInschrijving>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)] out List<CallbackInschrijving>? result)
            {
                result = null;
