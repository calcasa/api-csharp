            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/adressen/{bagNummeraanduidingId}");
        ...
        public async Task<ISearchAdresApiResponse> SearchAdresAsync(Adres adres, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/adressen/zoeken"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/adressen/zoeken");

                    httpRequestMessageLocalVar.Content = (adres as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
