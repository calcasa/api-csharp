...
namespace Calcasa.Api.Api
{
    ...
    public sealed partial class AdressenApi : IAdressenApi
    {
        ...
        public async Task<IGetAdresApiResponse> GetAdresAsync(long bagNummeraanduidingId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    if (!GetAdresApiResponse.IsFileStatus((int)httpResponseMessageLocalVar.StatusCode)){
                        ...
                        apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, string.Empty, "/adressen/{bagNummeraanduidingId}", requestedAtLocalVar, _jsonSerializerOptions);
                    }
        ...
        public partial class GetAdresApiResponse : Calcasa.Api.Client.ApiResponse, IGetAdresApiResponse
        {
            ...
            public override bool IsFile => GetAdresApiResponse.IsFileStatus((int)StatusCode);
        ...
        public async Task<ISearchAdresApiResponse> SearchAdresAsync(Adres adres, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    if (!SearchAdresApiResponse.IsFileStatus((int)httpResponseMessageLocalVar.StatusCode)){
                        string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        ...
                        apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, string.Empty, "/adressen/zoeken", requestedAtLocalVar, _jsonSerializerOptions);
                    }
        ...
        public partial class SearchAdresApiResponse : Calcasa.Api.Client.ApiResponse, ISearchAdresApiResponse
        {
            ...
            public override bool IsFile => SearchAdresApiResponse.IsFileStatus((int)StatusCode);
