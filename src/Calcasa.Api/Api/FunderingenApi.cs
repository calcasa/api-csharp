...
namespace Calcasa.Api.Api
{
    ...
    public sealed partial class FunderingenApi : IFunderingenApi
    {
        ...
        public async Task<IGetFunderingByIdApiResponse> GetFunderingByIdAsync(long bagNummeraanduidingId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    if (!GetFunderingByIdApiResponse.IsFileStatus((int)httpResponseMessageLocalVar.StatusCode)){
                        ...
                        apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, string.Empty, "/funderingen/{bagNummeraanduidingId}", requestedAtLocalVar, _jsonSerializerOptions);
                    }
        ...
        public partial class GetFunderingByIdApiResponse : Calcasa.Api.Client.ApiResponse, IGetFunderingByIdApiResponse
        {
            ...
            public override bool IsFile => GetFunderingByIdApiResponse.IsFileStatus((int)StatusCode);
