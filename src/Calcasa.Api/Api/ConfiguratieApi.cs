...
namespace Calcasa.Api.Api
{
    ...
    /// </summary>
    public interface IGetCallbacksApiResponse : Calcasa.Api.Client.IApiResponse, IOk<List<Callback>?>, IUnauthorized<Calcasa.Api.Model.UnauthorizedProblemDetails?>, IForbidden<Calcasa.Api.Model.PermissionsDeniedProblemDetails?>, IDefault<Microsoft.AspNetCore.Mvc.ProblemDetails?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUpdateCallbacksApiResponse : Calcasa.Api.Client.IApiResponse, IOk<List<Callback>?>, IBadRequest<Calcasa.Api.Model.InvalidArgumentProblemDetails?>, IUnauthorized<Calcasa.Api.Model.UnauthorizedProblemDetails?>, IForbidden<Calcasa.Api.Model.PermissionsDeniedProblemDetails?>, IDefault<Microsoft.AspNetCore.Mvc.ProblemDetails?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class ConfiguratieApi : IConfiguratieApi
    {
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/configuratie/callbacks/authentication");
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/configuratie/callbacks");
        ...
        public partial class GetCallbacksApiResponse : Calcasa.Api.Client.ApiResponse, IGetCallbacksApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public List<Callback>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<Callback>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)] out List<Callback>? result)
            {
                result = null;
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/configuratie/callbacks/mtls-certificate");
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/configuratie/callbacks/signature-keys");
        ...
        public async Task<IPostCallbackAuthenticationApiResponse> PostCallbackAuthenticationAsync(CallbackAuthentication callbackAuthentication, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    httpRequestMessageLocalVar.Content = (callbackAuthentication as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
        ...
        public async Task<IUpdateCallbacksApiResponse> UpdateCallbacksAsync(Callback callback, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    httpRequestMessageLocalVar.Content = (callback as object) is Calcasa.Api.Client.FileParameter fileParameterLocalVar
                        ? httpRequestMessageLocalVar.Content = new StreamContent(fileParameterLocalVar.Content)
