...
namespace Calcasa.Api.Api
{
    ...
    public partial class FotosApi : IDisposable, IFotosApi
    {
        ...
        public Calcasa.Api.Client.ApiResponse<FileParameter> GetFotoWithHttpInfo(Guid id)
        {
            ...
            var localVarResponse = this.Client.Get<FileParameter>("/api/v0/fotos/{id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Calcasa.Api.Client.ApiResponse<FileParameter>> GetFotoWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileParameter>("/api/v0/fotos/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
